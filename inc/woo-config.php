...
add_action('woocommerce_single_product_summary', function() {
    ...
    <div class="share-link">
        <label> <?php esc_html_e('Share ON:', 'appland') ?> </label>
...
add_filter( 'woocommerce_checkout_fields' , function ( $fields ) {
    $fields['billing']['billing_first_name'] = array(
        'label'     => '',
        'placeholder'   => esc_html_x('First name *', 'placeholder', 'appland'),
        'required'  => true,
    ...
    $fields['billing']['billing_last_name'] = array(
        'label'     => '',
        'placeholder'   => esc_html_x('Last name *', 'placeholder', 'appland'),
        'required'  => true,
        'class'     => array('col-md-6'),
        'clear'     => true
    );
    $fields['billing']['billing_company'] = array(
        'label'     => '',
        'placeholder'   => esc_html_x('Company name (optional)', 'placeholder', 'appland'),
        'required'  => false,
    ...
    $fields['billing']['billing_city'] = array(
        'label'     => '',
        'placeholder'   => esc_html_x('Town / City *', 'placeholder', 'appland'),
        'class'     => array('col-md-12'),
        'clear'     => true
    );
    $fields['billing']['billing_postcode'] = array(
        'label'     => '',
        'placeholder' => esc_html_x('Postcode / ZIP (optional)', 'placeholder', 'appland'),
        'class'     => array('col-md-12'),
        'clear'     => true
    );
    $fields['billing']['billing_phone'] = array(
        'label'     => '',
        'placeholder'   => esc_html_x('Phone', 'placeholder', 'appland'),
        'required'  => false,
        'class'     => array('col-md-6'),
        'clear'     => true
    );
    $fields['billing']['billing_email'] = array(
        'label'     => '',
        'placeholder'   => esc_html_x('Email address *', 'placeholder', 'appland'),
        'required'  => true,
        'class'     => array('col-md-6'),
        'clear'     => true
    );
