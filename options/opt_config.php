...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme settings', 'appland' ),
	'page_title'           => esc_html__( 'Apland theme settings', 'appland' ),
...
$args['footer_text'] = esc_html__( 'Copyright Appland &copy; 2018', 'appland' );
...
$tabs = array(
	array(
		'id'      => 'theme_help_links',
		'title'   => esc_html__( 'Theme help links', 'appland' ),
		'content' => wp_kses(__( '
						<p><a href="http://docs.droitthemes.com/docs/appland-docs/">Documentation</a></p>
						<p><a href="http://docs.droitthemes.com/docs/appland-docs/changes-log/">Theme changes log</a></p>
						', 'appland' ), $allowed_string)
	),
);
