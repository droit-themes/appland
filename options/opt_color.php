...
Redux::setSection('appland_opt', array(
	'title'     => esc_html__('Colors', 'appland'),
	'id'        => 'color',
	'icon'      => 'dashicons dashicons-admin-appearance',
	'fields'    => array(
		array(
			'id'          => 'accent_color_type',
			'title'       => esc_html__('Accent color type', 'appland'),
			'type'        => 'button_set',
			'default'     => 'gradient',
			'options'     => array(
				'gradient' => esc_html__('Gradient', 'appland'),
				'solid' => esc_html__('Solid', 'appland'),
			),
		),
		array(
			'id'          => 'accent_gradient',
			'type'        => 'color_gradient',
			'title'       => esc_html__( 'Gradient color', 'appland' ),
			'default'     => array(
			    'from' => '#4776e6',
			    'to' => '#8e54e9',
            ),
            'required'   => array('accent_color_type', '=', 'gradient')
		),
		array(
			'id'          => 'gradient_solid_color',
			'type'        => 'color',
			'title'       => esc_html__( 'Solid color', 'appland' ),
			'description' => esc_html__( 'Rest of color except the gradient color in solid color.', 'appland' ),
			'default'     => '#4776e6',
            'required'    => array('accent_color_type', '=', 'gradient'),
            'output'      => array(
                'background' => '
                    ...
                    nav.navbar.navbar-fixed-top.affix a.banner_btn.btn-getnow:hover, .price .pricing-box:hover .packeg_typ, .price .pricing-box:hover .purchase-btn',
                'color' => '
		...
		array(
			...
			'type'        => 'color',
			'title'       => esc_html__( 'Accent Solid Color', 'appland' ),
			'default'     => '#4c83ff',
            'required'    => array('accent_color_type', '=', 'solid'),
            'output'      => array(
                'color' => '
                    .woocommerce-message::before, .sale_product_item.pr_grid .pr_details h5:hover,
                    .woocommerce form.woocommerce-cart-form button.button:hover,
                    ...
                    .pricing_area_three .price_table .price_box:hover h2 span,
                    .pricing_area_three .price_table .price_box .screenshot-btn,
                    .post-widget .media .media-body .tn_tittle:hover, .sub_btn',
                'border-color' => '
                    .woocommerce nav.woocommerce-pagination ul li span.current,
                    .appland-search .home_btn,.header_error.affix .menu li a:hover,
                    .pagination span.page-numbers.current, .pagination a:last-child:hover,
                    ...
                    .pricing_area_three .price_table .price_box .screenshot-btn,
                    .affix .btn-getnow, .affix .menu li.active a, .affix .menu li a:hover, .sub_btn',
                'background' => '
                    .woocommerce nav.woocommerce-pagination ul li span.current,
                    form.checkout_coupon.woocommerce-form-coupon button,
                    .header_error .btn-getnow:hover,
                ...
                'border-top-color' => '.woocommerce-message, .woocommerce-info',
                '-webkit-text-fill-color' => '.thumbnail-blog:hover a, .thumbnail-blog:hover a i, .testimonial_area_four .test-carousel-three .item .icon i',
            )
		),
	)
));