                                ...
                                <li class="cart-single-item clearfix">
                                    ...
                                    <div class="cart-remove">
                                        ...
                                        echo apply_filters('woocommerce_cart_item_remove_link', sprintf(
                                            ...
                                            esc_html__('Remove this item', 'appland'),
                                            esc_attr($product_id),
                        ...
                        <?php if (sizeof(WC()->cart->get_cart()) != 0) : ?>
                            <li class="cart_f">
                                <div class="cart-pricing">
                                    <p class="total">
                                        <?php esc_html_e('Subtotal :', 'appland') ?>
                                        <span class="p-total text-right"> <?php wc_cart_totals_order_total_html(); ?> </span>
                                    </p>
                                </div>
                                <div class="cart-button text-center">
                                    <a href="<?php echo wc_get_cart_url() ?>"
                                       class="btn btn-cart btn-animated-none"> <?php esc_html_e('View Cart', 'appland') ?> </a>
                                    <a href="<?php echo wc_get_checkout_url() ?>"
                                       class="btn btn-cart btn-animated-none"> <?php esc_html_e('Checkout', 'appland') ?> </a>
                                </div>
                            </li>
                        <?php endif; ?>
                    </ul>
