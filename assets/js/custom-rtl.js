(function($) {
        ...
        function screenshotSlider() {
            ...
            if(screenshot.length) {
                screenshot.owlCarousel( {
                        loop:!0, margin:0, items:3, nav:!0, dots:!1,rtl:true, autoplay:!0, navContainer:".screenshot_area", smartSpeed:2000, navText:['<i class="ti-angle-left"></i>', '<i class="ti-angle-right"></i>'], responsiveClass:!0, responsive: {
                            0: {
                                items: 1,
                            }
                            , 400: {
        ...
        function screenShot() {
            ...
            if(screenshots_slider.length) {
                screenshots_slider.owlCarousel( {
                        loop:!0, margin:30, items:3,rtl: true, autoplay:!0, nav:!1, smartSpeed:700, responsiveClass:!0, responsive: {
                            0: {
                                items: 1,
                            }
                            , 420: {
        ...
        function testimonialSlider() {
            ...
            if(testslider.length) {
                testslider.owlCarousel( {
                        loop: !0, margin: 30, items: 1, nav: !0,rtl:true, dots: !1, autoplay: !0, autoplayHoverPause: true, navContainer: ".testimonial_carousel", smartSpeed: 2000, navText: ['<i class="ti-arrow-left"></i>', '<i class="ti-arrow-right"></i>']
                    }
                )
            }
        }
        ...
        function testimonialSliderthree() {
            ...
            if(testsliderthree.length) {
                testsliderthree.owlCarousel( {
                        loop: !0, margin: 30, items: 1,rtl: true, nav: !1, dots: !0, autoplay: !0, smartSpeed: 2000,
                    }
                )
            }
        }
        ...
        function testSlidersix() {
            ...
            if(testslider_6.length) {
                testslider_6.owlCarousel( {
                        loop:!0, margin:0, items:2, nav:!0, autoplay:!0,rtl: true, navContainer:'.testimonial_area_two', smartSpeed:2000, navText:['<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>'], responsiveClass:!0, responsive: {
                            0: {
                                items: 1,
                            }
                            , 680: {
        ...
        function clientsSlider() {
            ...
            if(clientslg_slider.length) {
                clientslg_slider.owlCarousel( {
                        loop:!0, margin:0, items:4, autoplay:!0,rtl:true, smartSpeed:1000, nav:!1, responsiveClass:!0, responsive: {
                            0: {
                                items: 1,
                            }
                            , 500: {
        ...
        function blogslider() {
            ...
            if(blogS.length) {
                blogS.owlCarousel( {
                        loop:!0, margin:30, items:3, nav:!1,rtl:true, autoplay:!0, smartSpeed:2000, responsiveClass:!0, responsive: {
                            0: {
                                items: 1,
                            }
                            , 550: {
